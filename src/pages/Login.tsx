  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 left-1/4 w-80 h-80 bg-snap-sky/5 rounded-full blur-[100px]" />
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-snap-purple/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <form onSubmit={handleLogin} className="glass rounded-2xl p-6 space-y-4">
          <Button variant="brand-outline" className="w-full" type="button" onClick={handleGoogleLogin}>
          ...
          <div className="flex justify-end">
            <Link to="/forgot-password" className="text-xs text-snap-sky hover:underline">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          ...
          <Link to="/register" className="text-snap-sky hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
